                ...
                {accountOpen && (
                  ...
                  >
                    ...
                    <div className="py-1">
                      ...
                      <Link href="/favoritos" role="menuitem" className="flex cursor-pointer items-center gap-3 px-4 py-2.5 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50" onClick={() => setAccountOpen(false)}>
